package com.disorderlylabs.paymentGateway;

import com.disorderlylabs.paymentGateway.faultInjection.Propagation;
import com.disorderlylabs.paymentGateway.faultInjection.TracingClientHttpRequestInterceptor;
import com.disorderlylabs.paymentGateway.faultInjection.TracingHandlerInterceptor;
...
public class TracingConfiguration extends WebMvcConfigurerAdapter {
  ...
  @Bean Tracing tracing(@Value("paymentGateway") String serviceName) {
